...
def plotPoincareDisc(x,
    ...
    marker = '.'
    for name, group in groups:        
        plt.scatter(group.x, group.y, marker=marker, facecolors=color_dict[name],
                 c=color_dict[name], edgecolors='none', s=ms, label=name)
    ...
    for name, group in groups:
        plt.scatter(group.x, group.y, marker=marker, facecolors=color_dict[name],
        c=color_dict[name], s=ms, edgecolors='none', label=name)
		
    plt.plot(0, 0, 'x', c=(1, 1, 1), ms=1)
