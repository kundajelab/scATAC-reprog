...
#truncate peaks to 500 bp around summit
python $TRUNCATE_PYTHON_SCRIPT --input_bed naive_overlap.optimal_set.bed --summit_flank 250 --outf naive_overlap.optimal_set.200.bed
...
getcounts () {
 ...
 bedtools coverage -counts -a naive_overlap.optimal_set.sorted.merged.bed \
        -b <(zcat ${cur_tagalign} | sort -k1,1 -k2,2n)  -sorted \
