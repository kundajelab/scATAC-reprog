...
def BPNet(seq_len, out_pred_len, 
          filters=64, n_dil_layers=9, conv1_kernel_size=21, 
          profile_kernel_size=75, num_tasks=2, control_smoothing=[1, 50]):
    ...
    layer_names = ['2nd', '3rd', '4th', '5th', '6th', '7th', '8th', '9th', '10th']
    for i in range(1, n_dil_layers + 1):
        ...
        conv_output = layers.Conv1D(filters, kernel_size=3, padding='same',
